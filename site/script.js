const translations = {
  en: {
    ...
    heroTitle: "Apple Music that knows when to step aside.",
    heroText: "FlowSound fades and pauses Apple Music when other apps play audio, then restores it when things become quiet again.",
    download: "Download for macOS",
    github: "View on GitHub",
    heroNote: "Built for macOS 26+. Apple Music only. Local-first, no analytics.",
    focusKicker: "Audio focus for Apple Music",
    focusTitle: "No more manual pause-resume loops.",
    focusPain: "Play a video or another audio source without stacking soundtracks on top of Apple Music.",
    focusStepOneTitle: "Apple Music plays normally",
    focusStepOneText: "Keep music in the background while you work.",
    focusStepTwoTitle: "Other audio starts",
    focusStepTwoText: "FlowSound fades Apple Music out and pauses it.",
    focusStepThreeTitle: "Other audio ends",
    focusStepThreeText: "Apple Music resumes from the paused position and fades back in.",
    focusOutcome: "Avoid overlapping audio. Avoid sudden silence. Stay in flow.",
    demoEyebrow: "Demo",
    demoTitle: "Watch FlowSound react to other audio.",
    demoText: "The menu bar app listens for app audio activity, fades Apple Music out, pauses it, then restores the previous volume.",
    trustEyebrow: "Trust",
    ...
    sourceText: "Built in Swift with Core Audio and Apple Music automation.",
    ...
    automationText: "Used to control Apple Music volume and playback.",
    ...
    faqSpotifyA: "Not yet. FlowSound currently supports Apple Music only.",
  ...
  zh: {
    ...
    heroTitle: "让 Apple Music 知道什么时候该退到一边。",
    heroText: "当其他 App 播放声音时，FlowSound 会自动淡出并暂停 Apple Music；安静后再恢复到之前的音量。",
    download: "下载 macOS 版",
    github: "查看 GitHub",
    heroNote: "适用于 macOS 26+。仅支持 Apple Music。本地运行，无分析统计。",
    focusKicker: "Apple Music 的 Audio Focus",
    focusTitle: "不用再反复手动暂停和恢复。",
    focusPain: "播放视频或其他声音时，不再让 Apple Music 和其他音轨叠在一起。",
    focusStepOneTitle: "Apple Music 正常播放",
    focusStepOneText: "工作时继续把音乐放在背景里。",
    focusStepTwoTitle: "其他音频开始",
    focusStepTwoText: "FlowSound 自动淡出并暂停 Apple Music。",
    focusStepThreeTitle: "其他音频结束",
    focusStepThreeText: "Apple Music 从刚刚暂停的位置继续播放，并渐强恢复。",
    focusOutcome: "避免多重音轨。避免突然安静。保持专注和 Flow。",
    demoEyebrow: "演示",
    demoTitle: "看看 FlowSound 如何响应其他声音。",
    demoText: "菜单栏应用会检测其他 App 的音频活动，淡出并暂停 Apple Music，然后恢复之前的音量。",
    trustEyebrow: "信任",
    ...
    sourceTitle: "开源",
    sourceText: "使用 Swift、Core Audio 和 Apple Music 自动化构建。",
    ...
    automationTitle: "自动化",
    automationText: "用于控制 Apple Music 的音量和播放状态。",
    loginTitle: "登录项",
    ...
    faqSpotifyA: "暂不支持。FlowSound 目前仅支持 Apple Music。",
